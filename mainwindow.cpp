...
MainWindow::MainWindow(QWidget *parent, Mouse3DInput* mouse3D)
    : QMainWindow(parent)
...
//    QObject::connect(ui->xSpinbox, qOverload<double>(&QDoubleSpinBox::valueChanged), stewart, &StewartPlatform::xMove);
//    QObject::connect(ui->ySpinbox, qOverload<double>(&QDoubleSpinBox::valueChanged), stewart, &StewartPlatform::yMove);
//    QObject::connect(ui->zSpinbox, qOverload<double>(&QDoubleSpinBox::valueChanged), stewart, &StewartPlatform::zMove);
//    QObject::connect(ui->rxSpinbox, qOverload<double>(&QDoubleSpinBox::valueChanged), stewart, &StewartPlatform::xRot);
//    QObject::connect(ui->rySpinbox, qOverload<double>(&QDoubleSpinBox::valueChanged), stewart, &StewartPlatform::yRot);
//    QObject::connect(ui->rzSpinbox, qOverload<double>(&QDoubleSpinBox::valueChanged), stewart, &StewartPlatform::zRot);
